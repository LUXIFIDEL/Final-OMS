...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form class="d-flex">
                  @if (Route::has('login'))
                      @auth
                      <a href="{{ route('redirect') }}" class="btn text-sm text-gray-700 dark:text-gray-500"> <i class="fa fa-home"></i> Home</a>
                      @else
        ...
        <main class="mobile">
          ...
          <div class="row">
              <div class="col-6 mx-auto">
                  <a style="margin-top: -20px;" href="{{route('login')}}" class="w-100 btn btn-lg btn-warning rounded-pill">ORDER NOW <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
              </div>
