            ...
            <div class="col-xl-3 col-xxl-3 col-sm-12">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-black invoice-num">{{$count_transaction->where('status','Pending')->count()}}</h2>
                            <span class="text-black fs-18">Pending</span>
                        </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-12">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-black invoice-num">{{$count_transaction->where('status','Inprocess')->count()}}</h2>
                            <span class="text-black fs-18">Inprocess</span>
                        </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-12">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-black invoice-num">{{$count_transaction->where('status','Completed')->count()}}</h2>
                            <span class="text-black fs-18">Completed</span>
                        </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-12">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-black invoice-num">{{$count_transaction->where('status','Cancelled')->count()}}</h2>
                            <span class="text-black fs-18">Cancelled</span>
                        </div>
